function symbolicDynamics = initSymbolicAeroSysDynamics(, g, m, J_t,d, S, l,Sm,C_A, C_Y_beta,C_N_alpha, C_m_q, C_m_alpha, C_n_r, C_n_beta, rho)
...
% C_n: Yawing aerodynamic moment coefficent [-]
    ...
    vdot= -g*(-sPsi) + qbar/m*S*C_Y - T/m*cmu1*smu2 - r * u;
    wdot = -g*(stheta*cPsi) - qbar/m*S*C_N - T/m*smu1  + q*u;
